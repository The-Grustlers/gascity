...
func TestInlineContentDispositionSanitizesFilenames(t *testing.T) {
	got := inlineContentDisposition("screen\r\nshot.png")
	if strings.ContainsAny(got, "\r\n") {
		t.Fatalf("Content-Disposition contains newline: %q", got)
	}
	if !strings.HasPrefix(got, "inline") || !strings.Contains(got, "screenshot.png") {
